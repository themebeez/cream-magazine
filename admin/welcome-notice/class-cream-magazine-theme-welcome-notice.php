...
if ( ! class_exists( 'Cream_Magazine_Theme_Welcome_Notice' ) ) {
	/**
	 * Class - Theme Notice.
	 *
	 ...
	 * @since 1.0.0
	 */
	class Cream_Magazine_Theme_Welcome_Notice {
		...
		public function enqueue_admin_assets() {
			...
			wp_enqueue_script(
				...
				array( 'jquery' ),
				CREAM_MAGAZINE_VERSION, // Update version here.
				true
			);
				...
				<div class="theme-notice__content">
						...
						<div class="theme-notice__head">
							<p class="theme-notice__subheading">
								...
								printf(
									...
									esc_html__( 'Hello, %s', 'cream-magazine' ),
							...
							<h2 class="theme-notice__heading">
								...
								printf(
									...
									esc_html__( 'Welcome to %s', 'cream-magazine' ),
							...
							<p class="theme-notice__description">
								...
								printf(
									...
									esc_html__( 'Thank you for choosing %1$s! To get started with %1$s and import starter templates, install Themebeez Toolkit plugin by clicking on the button below! We hope you enjoy using %1$s.', 'cream-magazine' ),
									esc_html( $this->theme_name )
								);
								?>
							</p>
							...
							<p>
								<button id="get-started-btn" class="theme-notice__button button button-primary">
									<span class="button-text">
										<?php echo esc_html__( 'Get Started', 'cream-magazine' ); ?>
									</span>
					...
					<div class="theme-notice__image">
						<img
							...
							alt="<?php echo esc_attr__( 'Notice Image', 'cream-magazine' ); ?>"
						>
					</div>
				</div>
			</div>
