<?php
/**
 * Customize sections and settings for archive page.
 *
 * @since 2.0.0
 *
...
if ( ! class_exists( 'Cream_Magazine_Customize_Archive_Page_Customize' ) ) {
	/**
	 * Define and register sections and settings for archive page.
	 *
	 * @since 2.0.0
	 *
	 * @package Cream_Magazine
	 */
	class Cream_Magazine_Customize_Archive_Page_Customize {
...
new Cream_Magazine_Customize_Archive_Page_Customize();
